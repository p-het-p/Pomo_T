        ...
        <div className="flex items-center justify-center gap-3 xs:gap-4 sm:gap-6">
          {[
            ...
            <button
              ...
              className={`tracking-wider text-[10px] xs:text-xs sm:text-sm transition-opacity whitespace-nowrap hover:opacity-60 ${
                appMode === item.id
                    ...
                    <div className="space-y-2 xs:space-y-3">
                      ...
                      <div className="flex flex-col xs:flex-row xs:items-center xs:justify-between gap-2 xs:gap-4">
                        ...
                        <input
                          ...
                          className="w-full xs:w-20 sm:w-24 px-2 sm:px-3 py-1.5 xs:py-2 bg-transparent border border-foreground/20 focus:border-foreground/40 outline-none text-center tabular-nums text-xs xs:text-base transition-colors rounded-full"
                        />
                      </div>
                    </div>
                  ...
                  >
                    ...
                    <div className="flex gap-1.5 xs:gap-2 sm:gap-3">
                      <motion.button
                        ...
                        className={`px-2 xs:px-3 sm:px-4 py-1.5 xs:py-2 sm:py-3 border transition-colors tracking-wider flex-1 text-[10px] xs:text-xs sm:text-sm rounded-full ${
                          !isDark 
